    ...
    public class PaySlipGeneratorController : ControllerBase
    {
        ...
        public IActionResult GeneratePaySlips([FromBody] EmployeeDetails employeeDetails)
        {
            ...
            catch (Exception ex)
            {
                ...
                return StatusCode(StatusCodes.Status500InternalServerError, $"Something went wrong. Please try again after sometime of get in touch with support team. Error: {ex.Message}");
            }
